    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── HERO — full screen like original ── */
        .hero {
          position: relative;
      ...
      <section className="hero" ref={heroRef} onMouseMove={handleMouseMove}>
        ...
        <div className="hero-radial" style={{ transform: `translate(${mousePos.x * 0.3}px, ${mousePos.y * 0.3}px)` }} />
        {particles.map((p, i) => (
        ...
        <h1 className="hero-title" style={{ transform: `translate(${mousePos.x * 0.4}px, ${mousePos.y * 0.3}px)` }}>
          Na<em>vel</em>la
        </h1>
      ...
      <div className="stats-bar">
        <div className="stat-item"><div className="stat-num">1,200+</div><div className="stat-label">Novels Published</div></div>
        <div className="stat-item"><div className="stat-num">48k</div><div className="stat-label">Active Readers</div></div>
        <div className="stat-item"><div className="stat-num">320</div><div className="stat-label">Authors</div></div>
        <div className="stat-item"><div className="stat-num">99%</div><div className="stat-label">Reader Satisfaction</div></div>
      </div>
      ...
      <section className="novels-section">
        <div className="section-header">
          <div>
            ...
            <h2 className="section-title">Stories worth<br /><em>losing yourself in</em></h2>
          </div>
          <span className="view-all-link" onClick={() => navigate("/browse")}>All Novels</span>
        </div>
        {loading && <div className="loading-state"><div className="loading-dots"><span /><span /><span /></div></div>}
        {!loading && novels.length === 0 && <div className="empty-state">No novels yet — be the first to publish one.</div>}
        <div className="novels-grid">
          {novels.map((novel) => <NovelCard key={novel._id} novel={novel} />)}
        </div>
      </section>
      ...
      <div className="cta-banner">
        ...
        <button className="btn-dark" onClick={() => navigate("/login")}>Create Free Account</button>
      </div>
